...
?>
                ...
                <div class="col-md-8 grid-margin stretch-card">
                    <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="employee_internal_id" placeholder="upto 10 digits" value="<?php echo $employee_internal_id; ?>">
                        </div>    
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control "name="employee_username" type="text" placeholder="30 characters max" value="<?php echo $employee_username; ?>">
                        </div>
    ...
    elseif(strlen($employee_address) > 100){
     ...
     elseif(strlen($employee_mobile) > 20){
       ...
       header("Location: viewAllEmployees.php?status=$tempMessage");
        ...
        if(!($password === $employee_actual_password)){
        
            $password = escape_it($password);
            $password = encryptPassword($password);
        
        }
         
         if(!($employee_cnic === $employee_actual_cnic)){
        
        if(check_Cnic_Exists($employee_cnic)){
    ...
    if(!($employee_email === $employee_actual_email)){
        
        if(check_Email_Exists($employee_email)){
        $tempMessage = "**Email Already Exists**";
        header("Location: viewAllEmployees.php?status=$tempMessage");
                        }
        
    }
    if(!($employee_internal_id === $employee_actual_internalid)){
        
        if(check_Employee_ID_Exists($employee_internal_id)){
    ...
    if(!($employee_username === $employee_actual_username)){
        
        if(check_Username_Exists($employee_username)){
