		...
		<div align="center">
			...
			<table border=2 style= "text-align: center;width:245px;margin-bottom:10px;display: inline;">
			    ...
			    <tr style="height: 50px;">
			        ...
			        <td>Basic SAR: <?php echo $a;//$employeeDetailsData['basic_salary'];?></td>
			        <td>Housing SAR: <?php echo $b;//$employeeDetailsData['housing_allowance'];?></td>
			        <!-- <td>Office Travel SAR: <?php echo $employeeDetailsData['conveyance_allowance'];?></td>
			        <td style=""></td> -->
			    ...
			    <tr>
			        ...
			        <td><table border = 1 ><tr><td style="width: 25px;"></td><td style="width: 100px;text-align:right;">Basic SAR</td></tr></table></td>
			    ...
			    <tr>
			        ...
			        <td><table border = 1 ><tr><td style="width: 25px;"></td><td style="width: 100px;text-align:right;">Housing SAR</td></tr></table></td>
			        ...
			        <td><table border = 1 ><tr><td style="width: 25px;"></td><td style="width: 100px;text-align:right;">Office Travel SAR</td></tr></table></td>
			    ...
			    <tr>
			        ...
			        <td><table border = 1 ><tr><td style="width: 25px;"></td><td style="font-size:9px;width: 100px;text-align:right;">Other Allowance SAR</td></tr></table></td>
			    ...
			    <tr>
			        ...
			        <td><table border = 1 ><tr><td style="width: 25px;"></td><td style="font-size:9px;width: 100px;text-align:right;">Food Allowance SAR</td></tr></table></td>
			        <td ><?php echo $food_allowance = 20 * ($Job); ?></td>
			        <!-- <td style="text-align:right;"></td>
			        <td ></td> -->
			    ...
			    <tr>
			        ...
			        <td><table border = 1 ><tr><td style="width: 25px;"></td><td style="font-size:9px;width: 100px;text-align:right;">Total SAR</td></tr></table></td>
			        <td ><?php echo $t; ?></td>
			        <!-- <td style="text-align:right;"></td>
			        <td ></td> -->
			...
			<table border=2 style= "text-align: center;width:245px;margin-bottom:10px;display: inline;">
			    ...
			    <tr style="height: 50px;">
			        ...
			        <!-- <td>Basic SAR: <?php echo $employeeDetailsData['basic_salary'];?></td>
			        <td>Housing SAR: <?php echo $employeeDetailsData['housing_allowance'];?></td> -->
			        <td>Office Travel SAR: <?php $c;//echo $employeeDetailsData['conveyance_allowance'];?></td>
			        <td style=""></td>
...
?>
    ...
    <table class="outerNew" border="1">
        ...
        <tr class="smallcolumns3">
            ...
            <td style="width:6%;"><?php echo $food_allowance = 20 * ($Job); ?></td>
            <td style="width:5%;"> &nbsp;</td>
            <td style="width:5%;"> <?php if($monthselect == 1){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 2){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 3){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 4){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 5){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 6){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 7){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 8){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 9){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 10){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 11){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
            <td style="width:5%;"> <?php if($monthselect == 12){ echo $food_allowance = 20 * ($Job); } else { echo '-'; }?></td>
        ...
        <?php if(!empty($employeePayments)){ $sr = 1; $totalPayment = 0; foreach($employeePayments as $payments) { ?>
        	<tr>


        		<td style="width:3%;text-align:center;"><?php echo $sr; ?></td>
        		<td style="width:12%;">Payment - <?php echo $sr;?></td>
        		<td style="width:6%;"><?php $totalPayment = $totalPayment + $payments['amount']; echo $payments['amount']; ?></td>
        		<td style="width:5%;"> &nbsp;</td>
        		<td style="width:5%;"> &nbsp;</td>
        		<td style="width:5%;"> &nbsp;</td>
        		<td style="width:5%;"> &nbsp;</td>
        	...
        	<tr>
        		...
        		<td style="width:3%;text-align:center;"><?php echo $sr; ?></td>
        		<td style="width:12%;">Date Payment - <?php echo $sr;?></td>
        ...
        <tr>
            ...
            <td colspan="3">Off Day :<br><?php if($absence) echo $absence; else echo 0; ?> </td>
        ...
        <tr>
            ...
            <td colspan="3">On Job :<br><?php echo $totalDays - $absence ?></td>
	...
	<?php } else if( $reporttypeselect == 'Maintenance Timesheet'){ 
		...
		<tbody>
		            ...
		            <?php $srNo=1; $totalHoursAll = 0; while($row = mysqli_fetch_assoc($getRegionStatus)) { $totalHours = 0; //print_r($row); ?>
		                    ...
		                    <table style="width:100%">
		                    <tr>
		                    <td class="" ><div><span><?php if(isset($getAttendance[0])){  if($row['status_option'] == $getAttendance[0]['status_option'] && $display) {  echo $getAttendance[0]['hours_worked']; $totalHours += $getAttendance[0]['hours_worked']; } else echo "<span style='color:white;'>0</span>";  } else echo "<span style='color:white;'>0</span>";  ?></span></div></td>
		                    </tr>
	...
	<div align="center">
		...
		<table border=2 style= "text-align: center;width:245px;margin-bottom:10px;display: inline;">
		    ...
		    <tr style="height: 50px;">
		        ...
		        <!-- <td>Basic SAR: <?php echo $employeeDetailsData['basic_salary'];?></td>
		        <td>Housing SAR: <?php echo $employeeDetailsData['housing_allowance'];?></td> -->
		        <td>Office Travel SAR: <?php echo $c;//$employeeDetailsData['conveyance_allowance'];?></td>
		        <td style=""></td>
...
<?php 
    ...
    <table class="outerNew" border="1">
				  ...
				  <tr>
					  ...
					  <td style="width:5%;"><?php
					  	...
					  	foreach($employeeSalary as $empSalary){
					  		...
					  		// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
					  		$jan_d = round( $empSalary['other_allowance']);
					...
					<td style="width:5%;"><?php
						...
						$feb_arrears = 0;
					  	foreach($employeeSalary as $empSalary){
					  		...
					  		// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
					  		$feb_d = round( $empSalary['other_allowance']);
					...
					<td style="width:5%;"><?php
						...
						$mar_arrears = 0;
					  	foreach($employeeSalary as $empSalary){
					  		...
					  		// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
					  		$mar_d = round( $empSalary['other_allowance']);
					 ...
					 if($rangetype == 'monthyear' ){
						...
						<td style="width:5%;"><?php
							...
							foreach($employeeSalary as $empSalary){
								...
								// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
								$apr_d = round( $empSalary['other_allowance']);
						...
						<td style="width:5%;"><?php
							...
							foreach($employeeSalary as $empSalary){
								...
								// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
								$may_d = round( $empSalary['other_allowance']);
						...
						<td style="width:5%;"><?php
					  	...
					  	foreach($employeeSalary as $empSalary){
					  		...
					  		// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
					  		$jun_d = round( $empSalary['other_allowance']);
						...
						<td style="width:5%;"><?php
							...
							foreach($employeeSalary as $empSalary){
								...
								// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
								$jul_d = round( $empSalary['other_allowance']);
						...
						<td style="width:5%;"><?php
							...
							foreach($employeeSalary as $empSalary){
								...
								// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
								$aug_d = round( $empSalary['other_allowance']);
						...
						foreach($employeeSalary as $empSalary){
							...
							// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
							$sep_d = round( $empSalary['other_allowance']);
						...
						<td style="width:5%;"><?php
							...
							foreach($employeeSalary as $empSalary){
								...
								// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
								$oct_d = round( $empSalary['other_allowance']);
						...
						<td style="width:5%;"><?php
							...
							foreach($employeeSalary as $empSalary){
								...
								// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
								$nov_d = round( $empSalary['other_allowance']);
						...
						<td style="width:5%;"><?php
							...
							foreach($employeeSalary as $empSalary){
								...
								// D = other_allowance x ((total days - (absence + unpaid leave)) / total days)
								$dec_d = round( $empSalary['other_allowance']);
        ...
        <tr class="smallcolumns3">
            ...
            <td style="width:12%;">Other Allowance</td>
            <td style="width:6%;"><?php echo $total_d;//$employeeDetailsData['other_allowance']; ?></td>
            <td style="width:5%;"> &nbsp;</td>
            <td style="width:5%;"> <?php echo $jan_d?></td>
            <td style="width:5%;"> <?php echo $feb_d?></td>
            <td style="width:5%;"> <?php echo $mar_d?></td>
            <td style="width:5%;"> <?php echo $apr_d?></td>
            <td style="width:5%;"> <?php echo $may_d?></td>
            <td style="width:5%;"> <?php echo $jun_d?></td>
            <td style="width:5%;"> <?php echo $jul_d?></td>
            <td style="width:5%;"> <?php echo $aug_d?></td>
            <td style="width:5%;"> <?php echo $sep_d?></td>
            <td style="width:5%;"> <?php echo $oct_d?></td>
            <td style="width:5%;"> <?php echo $nov_d?></td>
            <td style="width:5%;"> <?php echo $dec_d?></td>
        ...
        <tr class="smallcolumns3">
            ...
            <td style="width:12%;">Food Allowance</td>
            <td style="width:6%;"><?php echo $food_allowance_total = 20 * ($jan_Job + $feb_Job + $mar_Job + $apr_Job + $may_Job + $jun_Job + $jul_Job + $aug_Job + $sep_Job + $oct_Job + $nov_Job + $dec_Job); ?></td>
            <td style="width:5%;"> &nbsp;</td>
            <td style="width:5%;"> <?php echo 20 * $jan_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $feb_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $mar_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $apr_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $may_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $jun_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $jul_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $aug_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $sep_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $oct_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $nov_Job?></td>
            <td style="width:5%;"> <?php echo 20 * $dec_Job?></td>
        ...
        <tr class="smallcolumns3">
            ...
            <td style="width:12%;">Total Salary</td>
            <td style="width:6%;"><?php echo $total_t + $food_allowance_total; //$employeeDetailsData['basic_salary'] + $employeeDetailsData['housing_allowance'] + $employeeDetailsData['conveyance_allowance'] + $employeeDetailsData['other_allowance'] + $food_allowance ?></td>
            <td style="width:5%;"> &nbsp;</td>
        ...
        <tr>
            ...
            <td colspan="2">Total Salary:<br><?php echo $total_t + $food_allowance_total;?></td>
            <td colspan="3">CasualLeave :<br><?php if($CasualLeave_total) echo $CasualLeave_total; else echo 0; ?></td>
            <td colspan="3">Off Day :<br><?php if($absence_total) echo $absence_total; else echo 0; ?> </td>
            <td colspan="3">Idle :<br><?php if($Idle_total) echo $Idle_total; else echo 0; ?> </td>
            <td colspan="3">National Holiday :<br><?php if($NationalHoliday_total) echo $NationalHoliday_total; else echo 0; ?></td>
            <td colspan="2">-</td>
        ...
        <tr>
            ...
            <td colspan="3">Sick Leave :<br><?php if($SickLeave_total) echo $SickLeave_total; else echo 0; ?></td>
            <td colspan="3">On Job :<br><?php echo $totalDays - $absence ?></td>
...
<?php } else if( $reporttypeselect == 'Maintenance Timesheet'){ 
	...
	<tbody>
	            ...
	            <?php $srNo=1; $totalHoursAll = 0; while($row = mysqli_fetch_assoc($getRegionStatus)) { $totalHours = 0; //print_r($row); ?>
	                    ...
	                    <table style="width:100%">
	                    <tr>
	                    <td ><div><span><?php if(isset($getAttendance[0])){  if($row['status_option'] == $getAttendance[0]['status_option'] && $display) {  echo $getAttendance[0]['hours_worked']; $totalHours += $getAttendance[0]['hours_worked']; } else echo "<span style='color:white;'>0</span>";  } else echo "<span style='color:white;'>0</span>";  ?></span></div></td>
	                    </tr>
