                  ...
                  <div class="card" style="background: #fcfcfc; padding: 15px;" id = "singleform">
                    ...
                    <div class="" style="background: #fcfcfc; padding: 15px;" id = "allform" >
                      ...
                      <!-- 
                        ...
                        <div class="form-group">
                        <label for="exampleFormControlSelect2">Select Region</label>
                        <select class="form-control" id="exampleFormControlSelect2" name="regionselectall" id="regionselectall" required>
                          <option value="" disabled selected>Select Region</option>
                          <?php foreach($locations as $row){ ?>
                        ...
                        <div class="form-group">
                          <label for="exampleFormControlSelect2">Select Month</label>
                          <select class="form-control" id="exampleFormControlSelect2" name="monthall" id="monthall">
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                            <option value="4">4</option>
                        ...
                        <div class="form-group">
                          <label for="exampleFormControlSelect2">Select Year</label>
                          <select class="form-control" id="exampleFormControlSelect2" name="yearall" id="yearall">
                            <option value = "2018">2018</option>
                            <option value = "2019">2019</option>
                            <option value = "2020">2020</option>
                          </select>
...
function generatepayrollSingle(){
  ...
  if (region != "" && region != null && employee != "" && employee != null){
    ...
    $.ajax({
              type : "POST",
              data : "regionselect="+ region+"& payrolltype="+payrollType+"& employeeSelect="+employee+"& month="+month+"&year="+year+"&sendemail="+emailIntimation,
