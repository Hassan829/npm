...
<div class="form-inline">
  ...
  <label >Import Data</label>&nbsp;&nbsp;&nbsp;
    <input type="file" class="form-control" name="accountsData" placeholder="Upload file" accept=".xlsx" required>
    &nbsp;&nbsp;&nbsp;
    <input type = "submit" class="btn btn-sm btn-primary"/>

     <a  style="margin-left: 5px" class="btn btn-sm btn-primary" href="templates/Importtemplatev1.xlsx" download>Download<br> Template </a>
