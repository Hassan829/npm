...
if (!isset($_SESSION['id'])){
  header("Location: login.php?status=Unauthorized access!");
}
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <?php if (strtolower($_SESSION["role"])=="super admin"){ ?>
          <li class="nav-item">
            <a href="payrollManagement.php" class="nav-link">Payroll Management
        ...
        <?php } ?>
          ...
          <li class="nav-item">
            <a href="addattendanceentry.php" class="nav-link">
              <i class="mdi mdi-bookmark-plus-outline"></i>Attendance</a>
          </li>
        </ul>
        <ul class="navbar-nav navbar-nav-right">

          <!--
          Commented Messages dropdown    
          ...
          <!-- 
          Commented Notification dropdown 
          <li class="nav-item dropdown">
...
?>
              <img class="img-xs rounded-circle" src="<?php echo $image_path; ?>" >
            </a>
